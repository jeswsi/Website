...
<html lang="en">
  <head>
	...
	echo $head;	
	?>
	<meta name="description" content="Virtual Diagnostics including Stray light analysis for fusion, plasma energy, and physics labs. WSI has engineered and built vacuum systems, pulsed power systems, and high field magnets. We can perform basic Thermal and Structural analysis with FEM software.">
  ...
  <body>
	...
	<ol class="breadcrumb">
  		...
  		<li class="active">Virtual Diagnostics</li>
	</ol>


	<h1>Virtual Diagnostics</h1>
