...
<html lang="en">
  <head>
	...
	echo $head;	
	?>
  <meta name="description" content="Double tip Langmuir probes for fusion, plasma energy, and physics labs. Custom sizing, materials, and configurations available.">

  <title>Double Tip Langmuir Probes | Woodruff Scientific, Inc.</title>
  </head>
  ...
  <body>
	...
	<h1>Langmuir Probes</h1>
		<div class="col-md-6">
		<p class="center"><a href="img/double_tip.jpg"><img src="img/double_tip-small.jpg"></a><br />Double-tip Langmuir Probe</p>
	</div>
