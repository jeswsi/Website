...
<html lang="en">
  <head>
	...
	echo $head;	
	?>
  <meta name="description" content="Flat Langmuir probes for fusion, plasma energy, and physics labs. Custom sizing, materials, and configurations available.">

  <title>Flat Langmuir Probes | Woodruff Scientific, Inc.</title>
  </head>
