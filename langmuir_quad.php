...
<html lang="en">
  <head>
	...
	echo $head;	
	?>
  <meta name="description" content="Quad tip Langmuir probes for fusion, plasma energy, and physics labs. Custom sizing, materials, and configurations available.">

  <title>Quad Tip Langmuir Probes | Woodruff Scientific, Inc.</title>
  </head>
  ...
  <body>
	...
	<h1>Langmuir Probes</h1>
		<div class="col-md-6">
		<p class="center"><a href="img/quad_tip.jpg"><img src="img/quad_tip-small.jpg"></a><br />Quad-tip Langmuir Probe</p>
	</div>
